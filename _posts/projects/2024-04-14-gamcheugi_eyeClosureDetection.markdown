...
date:   2024-04-14 01:15:16 +0900
categories: projects
tags: gamcheugi computervision
---

Eye Aspect Ratio는 눈의 가로 세로 비율을 말한다. 눈이 감기면 가로 방향(x)의 비율은 변함이 없지만, 세로 방향의 비율만 감소하므로  
가로 세로 비율의 변화를 관찰하면 눈을 감았는지 여부를 정량적으로 판단할 수 있다. 
